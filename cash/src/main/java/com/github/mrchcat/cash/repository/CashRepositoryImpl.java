...
public class CashRepositoryImpl implements CashRepository {
    ...
    public CashTransaction createNewTransaction(CashTransaction cashTransaction) {
        System.out.println("зашли в createNewTransaction " + cashTransaction);
        String query = """
        ...
        System.out.println("вышли из createNewTransaction " + cashTransaction);
    ...
    public void changeTransactionStatus(long id, TransactionStatus newStatus) {
        System.out.println("зашли в changeTransactionStatus " + id + "  " + newStatus);
        String query = """
        ...
        System.out.println("зашли в changeTransactionStatus update=" + updated);
        if (updated == 0) {
